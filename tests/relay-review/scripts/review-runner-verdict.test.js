...
const {
  ...
  validateRubricScore,
  validateScopeDrift,
} = require("../../../skills/relay-review/scripts/review-runner/verdict");
const { REVIEW_VERDICT_JSON_SCHEMA, REVIEWER_VERDICT_JSON_SCHEMA } = require("../../../skills/relay-review/scripts/review-schema");

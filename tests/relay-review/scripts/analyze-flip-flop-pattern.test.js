...
const {
  ...
  parseArgs,
  renderReport,
} = require("../../../skills/relay-review/scripts/analyze-flip-flop-pattern");

const SCRIPT_PATH = path.join(__dirname, "..", "..", "..", "skills", "relay-review", "scripts", "analyze-flip-flop-pattern.js");

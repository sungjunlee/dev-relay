...
test("forceTransitionState bypasses ALLOWED_TRANSITIONS but keeps enum + invariant checks", () => {
  const { forceTransitionState } = require("../../../skills/relay-dispatch/scripts/relay-manifest");
  const manifest = {
...
const { readTextFileWithoutFollowingSymlinks } = require("../../../skills/relay-dispatch/scripts/relay-manifest");

...
function loadRegisterClaudeApp(execFileSyncImpl) {
  ...
  delete require.cache[require.resolve("../../../skills/relay-dispatch/scripts/claude-app-register")];
  childProcess.execFileSync = execFileSyncImpl;
  try {
    return require("../../../skills/relay-dispatch/scripts/claude-app-register").registerClaudeApp;
  } finally {

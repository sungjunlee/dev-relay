...
const CLI_TARGETS = [
  ...
  ["relay-dispatch", "skills/relay-dispatch/scripts/relay-config.js",
    ["check", "dispatch", "codex", "--json", "--no-merge"], "--no-merge"],
  ...
  ["relay-review", "skills/relay-review/scripts/review-runner.js",
    ["--repo", ".", "--run-id", "fake", "--no-merge"], "--no-merge"],
  ["relay-merge", "skills/relay-merge/scripts/relay-reconcile-artifact.js",
    ["--json", "--no-merge"], "--no-merge"],
  ["relay-merge", "skills/relay-merge/scripts/sprint-close-report.js",
    ["--help", "--no-merge"], "--no-merge"],
  ...
  ["relay-ready", "skills/relay-ready/scripts/probe-readiness.js",
    ["--json", "--no-merge"], "--no-merge"],
  ...["antigravity", "claude", "codex", "cursor", "opencode", "pi"].map((reviewer) => [
    "relay-review",
    `skills/relay-review/scripts/invoke-reviewer-${reviewer}.js`,
    ["--json", "--no-merge"],
    "--no-merge",
  ]),
];

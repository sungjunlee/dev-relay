...
// Adapter-owned literal stderr signals that definitively mean the provider is unavailable
// (quota/billing exhaustion). The supervisor matches them against lowercased stderr text and
// force-cancels a live attempt; they are host config, never forwarded into any durable record,
// fact payload, or Relay log. An adapter that declares none opts out entirely (empty set).

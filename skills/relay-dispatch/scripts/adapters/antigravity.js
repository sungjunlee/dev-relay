...
const native = createNativeAdapter({
  ...
  phases: {
    ...
    dispatch: { supported: true, write: true, readOnly: false, networkControl: "informational", filesystemIsolation: "declaration_only", cancellation: "process", structuredOutput: "json", commandExecution: true },

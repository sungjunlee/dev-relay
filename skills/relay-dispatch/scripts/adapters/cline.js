...
module.exports = createNativeAdapter({
  ...
  phases: {
    dispatch: { supported: true, write: true, readOnly: false, networkControl: "informational", filesystemIsolation: "none", loopbackListen: "available", cancellation: "process", structuredOutput: "jsonl" },

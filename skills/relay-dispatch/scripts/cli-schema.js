...
const FLAGS = [
  ...
  { flag: "--auto-recover-commit", kind: BOOLEAN, mode: MODE_PARSED, rationale: "Explicit dispatch opt-in to run recover-commit after completed-uncommitted for executors without a default; no value is consumed." },
  ...
  { flag: "--no-auto-recover-commit", kind: BOOLEAN, mode: MODE_PARSED, rationale: "Explicit dispatch opt-out from codex and claude default recover-commit after completed-uncommitted; no value is consumed." },

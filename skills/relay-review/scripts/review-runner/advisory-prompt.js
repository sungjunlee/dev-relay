...
function buildAdvisoryPrompt({
  ...
  return [
    ...
    "For every finding, line must be a positive integer or null. Never use 0.",
    "Use null only when the finding is genuinely file-wide or no single line accurately locates it; otherwise use the exact positive line number.",
    "null is only a location representation: it does not make a required finding advisory or optional, so keep every merge-blocking finding in required_findings.",

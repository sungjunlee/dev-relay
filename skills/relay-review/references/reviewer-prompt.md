...
Do not invent prior ids or infer stale semantics from wording alone. `relates_to` may be a concise prior issue title, factor name, stale artifact, or round/factor reference, but it must be non-empty when present.

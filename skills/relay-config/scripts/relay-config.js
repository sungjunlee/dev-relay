...
function printHelp() {
  ...
  console.log("  preset add|remove|show <name> [--dispatch <actor[:provider/model]>] [--review <actor[:provider/model]>] [--advisory-review <actor[:provider/model]>] [--review-assurance <compact|standard|hardened>] [--json]");

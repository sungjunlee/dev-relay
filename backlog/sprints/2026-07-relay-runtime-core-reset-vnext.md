...
- 2026-08-09 — Closure inventory measured 16 dispatch-runtime files / 6,900 LOC. The 14–18-file target was met; the 4,000–6,000 LOC projection was missed by 900 LOC. Sprint completion records the functional reset, while the measured recovery and test-accounting exceptions moved to #1195/#1196 under epic #1197 rather than being hidden by the completed status.

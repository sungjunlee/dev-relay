...
| Optional/advanced surface | `relay-sidecar`, `relay-fleet` | Specialized workflows for advisory lanes and fan-out. They should point to narrow references rather than expanding the core command surface. |

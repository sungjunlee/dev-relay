...
| `dispatch.js` | 627 | Worktree containment; dispatch never commits, pushes, opens a PR, or recovers | Justified |
...
live call site, and the rows sum to exactly 6,044.
...
3,185 LOC plus 1,463 lines of ledger artifacts to account for a 6,044-LOC runtime
...
This layer did **not** shrink when the runtime it accounts for lost 2,218 lines —
the ledgers gave back 65. That is tripwire A in

...
| --- | ---: | ---: | --- |
| Dispatch runtime core | 16 | 6,028 | Justified. Each file owns a distinct invariant. |
...
| `dispatch.js` | 611 | Worktree containment; dispatch never commits, pushes, opens a PR, or recovers | Justified |
...
live call site, and the rows sum to exactly 6,028.
...
3,185 LOC plus 1,460 lines of ledger artifacts to account for a 6,028-LOC runtime
...
This layer did **not** shrink when the runtime it accounts for lost 2,234 lines —

...
2. Reduce production runtime code from 29,607 lines to a 4,000-6,000 line
   budget. Delivered at 6,044 lines with no migration shims outstanding — 44
   lines over the band.
...
- Installed dispatch runtime: 16 JavaScript files / 6,044 LOC (measured into
...
9. **Subtraction gate:** final runtime is 14-18 files and 4,000-6,000 production
   ...
   6,044 LOC — inside the file target, above the LOC band because production CLI
...
9. Final measured runtime is 14-18 JavaScript files and 4,000-6,000 production
   ...
   files / 6,044 lines:** the file target is met, the LOC band is exceeded by
   44 lines. The overrun is production CLI isolation (#1141), not migration
...
and the measured runtime misses it by 44 lines; see Definition of Done item 9.

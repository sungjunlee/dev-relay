...
vNext production currently installs **16 JavaScript files / 6,044 production
LOC** under `skills/relay-dispatch/scripts/`.

| Group | Files | LOC | Purpose |
| --- | ---: | ---: | --- |
| Core | 8 | 5,686 | `dispatch`, `inspect`, `recover`, `run-store`, `facts`, `host`, `exec`, and `adapter-contract`. |

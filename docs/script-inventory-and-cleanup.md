...
vNext production currently installs **16 JavaScript files / 6,028 production
LOC** under `skills/relay-dispatch/scripts/`.

| Group | Files | LOC | Purpose |
| --- | ---: | ---: | --- |
| Core | 8 | 5,670 | `dispatch`, `inspect`, `recover`, `run-store`, `facts`, `host`, `exec`, and `adapter-contract`. |

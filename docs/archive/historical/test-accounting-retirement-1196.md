...
| --- | ---: | --- | --- | ---: |
| Test ledger generator, its tests, and five ledger artifacts | 1,859 | Deleted/renamed test identity or stale generated output | Direct filesystem↔CI equality plus exact directive policy; ordinal accounting deleted | 281 |
...
Net accounting reduction is **3,847 LOC** before the additional narrowing of
